...
from smallsat_sim.communication.dummy import DummyPublisher, DummyReceiver, create_communication_channels
...
receiver, publisher = create_communication_channels(env.env_cfg, env.model, ctrl)
