...
def randomize_initial_state() -> tuple[np.ndarray, np.ndarray]:
    ...
    positions = [
        ...
        [-1.1, 0.0, astrobee_height],
        [-1.1, 0.8, astrobee_height],
    ]
    ...
    class control:
        ...
        class NominalMPCC:
            ...
            class cost:
                ...
                Q_omega = 1e-1 * np.eye(3)
                # Q_omega = 1e-0 * np.eye(3)
