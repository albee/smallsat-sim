...
class MissionPlanner2DSquareSmall(MissionPlanner):
    """
    ...
    def _load_waypoints(self) -> None:
        ...
        astrobee_height = 0.4
        # positions = [
        #     # [-0.6, 0.8, astrobee_height],
        #     [-0.35, 0.9, astrobee_height],
        #     [-0.11467400000000001, 0.323508, astrobee_height],
        #     # [-0.43315899999999996, -0.103408, astrobee_height],
        #     [-0.3, 0.0, astrobee_height],
        #     [-0.35, -0.2, astrobee_height],
        #     [-0.4, -0.4, astrobee_height],
        #     [-0.45, -0.6, astrobee_height],
        #     [-0.45, -0.8, astrobee_height],
        #     [-0.45, -1.0, astrobee_height]
        # ]
        # positions = [
        #     [0.5, 0.0, astrobee_height],
        #     [0.375, -0.375, astrobee_height],
        #     [0.0, -0.5, astrobee_height],
        #     [-0.375, -0.375, astrobee_height],
        #     [-0.5, 0.0, astrobee_height],
        #     [-0.375, 0.375, astrobee_height],
        #     [0.0, 0.5, astrobee_height],
        ...
        # ]
        # positions = [
        #     [1.5, 0.0, astrobee_height],
        #     [1.0, -1.0, astrobee_height],
        #     [0.0, -1.5, astrobee_height],
        #     [-1.0, -1.0, astrobee_height],
        #     [-1.5, 0.0, astrobee_height],
        #     [-1.0, 1.0, astrobee_height],
        #     [0.0, 1.5, astrobee_height],
