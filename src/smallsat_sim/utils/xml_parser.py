...
# ===========================================LUNAR GATEWAY ====================================================
# =============================================================================================================
def generate_mujoco_xml_gateway(env_config, model_config, free_floating: bool = False):
    """
    This function generates the xml string which is fed to MuJoCo for setting up the sim environment
    """
    # Extract relevant quantities from configs
    ...
    if not free_floating:
        joint_str = """
            <joint name="slide_x" type="slide" axis="1 0 0" stiffness="0" damping="0" frictionloss="0" armature="0"/>
            <joint name="slide_y" type="slide" axis="0 1 0" stiffness="0" damping="0" frictionloss="0" armature="0"/>
            <joint name="yaw" type="hinge" axis="0 0 1" stiffness="0" damping="0" frictionloss="0" armature="0"/>
        """
        for body in bodies.bodies_list:
            body.euler[0] = 0
            body.euler[1] = 0
