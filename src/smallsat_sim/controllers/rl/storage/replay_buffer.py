...
class ReplayBuffer(object):
    ...
    def __init__(
        ...
        self.extrinsics_buf = jnp.zeros(combined_shape(size, (num_envs, ext_dim)))
        self.gamma = gamma
        self.lam = lam
        self.ptr = 0
    ...
    def store(
        ...
        self.extrinsics_buf = self.extrinsics_buf.at[self.ptr].set(extrinsics)
    ...
    def get(self):
        ...
        data = dict(
            ...
            logp=self.logp_buf,
            extrinsics=self.extrinsics_buf,
        )
